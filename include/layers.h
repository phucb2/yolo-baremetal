...
typedef struct {
    ...
    int padding;
    int groups;
    float input_scale; /* >0: quantize activations when weight is INT8 */
} conv_params_t;
...
status_t conv_block_forward(tensor_t* output, const tensor_t* input, const tensor_t* weight, const tensor_t* bias,
...
status_t bottleneck_forward(tensor_t* output, const tensor_t* input, const tensor_t* cv1_w, const tensor_t* cv1_b,
                            const tensor_t* cv2_w, const tensor_t* cv2_b, bool shortcut, tensor_t* temp);
...
status_t sppf_forward(tensor_t* output, const tensor_t* input, const tensor_t* cv1_w, const tensor_t* cv1_b,
                      const tensor_t* cv2_w, const tensor_t* cv2_b, int kernel_size, int n_pool, bool shortcut,
                      tensor_t* buffers);
...
status_t c3k2_forward(tensor_t* output, const tensor_t* input, int n, bool shortcut, const tensor_t* cv1_w,
                        const tensor_t* cv1_b, const tensor_t* cv2_w, const tensor_t* cv2_b, const tensor_t* b_weights,
                        tensor_t* buffers);
...
status_t psablock_forward(tensor_t* output, const tensor_t* input, bool shortcut, const tensor_t* qkv_w,
                          const tensor_t* qkv_b, const tensor_t* proj_w, const tensor_t* proj_b, const tensor_t* pe_w,
                          const tensor_t* pe_b, const tensor_t* ffn0_w, const tensor_t* ffn0_b, const tensor_t* ffn1_w,
...
status_t dwconv3x3_same_forward_fuse_silu(tensor_t* out, const tensor_t* in, const tensor_t* w, const tensor_t* bias);

/* INT8 depthwise when w is TENSOR_DTYPE_INT8 and input_scale > 0. */
